...
import LoginForgetPassword from '../Molecules/Login/LoginForgetPassword'
import LoginMaintenance from '../Molecules/Login/LoginMaintenance'
import LoginPasswordChanged from '../Molecules/Login/LoginPasswordChanged'
import LoginRegister from '../Molecules/Login/LoginRegister'
...
const LoginEnvironment = () => {
  ...
  return (
    <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5 
                        h-[100%] relative max-sm:w-[100%] max-md:w-[70%]">
          <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
            <div className="md:flex w-full">
              ...
              {(showItem === 'login' || showLogin) && (
                <Login setShowItem={setShowItem} />
              )}

              {showItem === 'register' && (
                <LoginRegister setShowItem={setShowItem} />
              )}

              {showItem === 'forgetPassword' && (
                <LoginForgetPassword setShowItem={setShowItem} />
              )}

              {passwordChanged && (
                <LoginPasswordChanged setShowItem={setShowItem} email={user?.email || ''} />
              )}
            </div>
          </div>
        </div>
...
export default LoginEnvironment