...
import { delay } from '../components/Commons/Commons.js'
...
export default function Home() {
  ...
  const [showItem, setShowItem] = useState<string>('login')
  ...
  const validateStoreName = (clinicName: string) => {
    return clinicName.length > 4
  }
  ...
  return (
    <>
      ...
      {loggedIn ? (
        ...
        <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5 w-[85%]">
          <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
            <div className="md:flex w-full">
                      ...
                      <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                          <label className="text-xs font-semibold px-1">
                            Fizemos uma pausa para atualizar nosso sistema.
                          </label>
                        </div>
                      </div>
                      <div className="flex -mx-3">
              ...
              {(showItem === 'login' || showLogin) && (

                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                  <div className="text-center mb-10">
                    <h1 className="font-bold text-3xl text-gray-900">ENTRAR</h1>
                    <p>Preencha seu email e sua senha</p>
                  </div>
                  <div>
                    <form onSubmit={handleSubmitLogin}>
                        ...
                        <div className="w-full px-3 mb-5">
                          ...
                          <div className="flex">
                            ...
                            <input
                              ...
                              id="floating_email"
                              className="block py-2.5 px-0 w-full text-sm text-gray-300 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-300 dark:focus:border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 peer"
                              placeholder=" "
                      ...
                      <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                          <label className="text-xs font-semibold px-1 cursor-pointer"
                            onClick={() => {
                          ...
                          <div className="flex">
                            <div
                              className="text-sm mt-2 text-gray-300 font-thin underline underline-offset-8 cursor-pointer"
                  ...
                  <div>
                    <form onSubmit={handleSubmit}>
                      <div className="flex -mx-3">
                        ...
                        <div className="w-1/2 px-3 mb-5">
                          <label className="text-xs font-semibold px-1">CRP / CRM</label>
                          <div className="flex">
                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-content-paste text-gray-400 text-lg"></i></div>
                            <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="" />
                          </div>
                        </div>
                      </div>
                      <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                          <label className="text-xs font-semibold px-1">Nome da Clínica</label>
                          <div className="flex">
                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-heart-box-outline text-gray-400 text-lg"></i></div>
                            <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="seunome@exemplo.com"
                              value={clinicName}
                      ...
                      <div className="flex -mx-3">
                        ...
                        <div className="w-1/2 px-3 mb-5">
                          <label className="text-xs font-semibold px-1">Confirmação de senha</label>
                          <div className="flex">
                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                            <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"
              ...
              {showItem === 'forgetPassword' && (

                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                  <div className="text-center mb-10">
                    <h1 className="font-bold text-3xl text-gray-900">RECUPERAR SENHA</h1>
              ...
              {passwordChanged && (
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                  <div className="text-center mb-10">
                    <h1 className="font-bold text-3xl text-gray-900">TROCAR SENHA</h1>
